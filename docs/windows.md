...
- `build/windows/moss/moss-lsp.exe`: standalone language server
- `build/windows/moss/Moss Studio.exe`: desktop Studio launcher
- `installer/Moss-0.5.0-Windows-Setup.exe`: Windows installer
- `installer/Moss-0.5.0-Windows-Portable.zip`: portable compiler, LSP, and Studio
- `installer/SHA256SUMS.txt`: release artifact checksums
