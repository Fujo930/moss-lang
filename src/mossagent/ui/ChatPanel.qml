...
Rectangle {
    ...
    Rectangle {
        ...
        width: bridge.fileViewerPath !== "" ? Math.max(360, parent.width * 0.45) : 0
        color: window.cBg0
        border.color: window.cBg3
        border.width: 1
        clip: true
        visible: bridge.fileViewerPath !== ""
        z: 10
        ...
        ColumnLayout {
            ...
            Rectangle {
                ...
                RowLayout {
                    ...
                    Text {
                        text: bridge.fileViewerPath || ""
                        color: window.cFg1; font.pixelSize: 13
                        elide: Text.ElideRight; Layout.fillWidth: true
                    }
                    Rectangle {
                        width: 28; height: 28; radius: 6
                        color: window.cBg2; border.color: window.cBg3
                        Text { anchors.centerIn: parent; text: "✕"; color: window.cFg2; font.pixelSize: 12 }
                        MouseArea {
                            anchors.fill: parent; cursorShape: Qt.PointingHandCursor
                            onClicked: bridge.closeFileViewer()
                        }
                    }
                }
            }
            ...
            Flickable {
                ...
                contentWidth: viewerText.width; contentHeight: viewerText.height
                clip: true
                boundsBehavior: Flickable.StopAtBounds

                ScrollBar.vertical: ScrollBar {
                    policy: ScrollBar.AlwaysOn
                    parent: viewerFlick.parent
                    anchors.right: viewerFlick.right
                    anchors.top: viewerFlick.top
                    anchors.bottom: viewerFlick.bottom
                }

                Text {
                    id: viewerText
                    width: viewerFlick.width - 16
                    text: bridge.fileViewerContent || ""
                    color: window.cFg1
                    font.pixelSize: 12
